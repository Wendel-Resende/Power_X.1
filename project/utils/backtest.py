...
class Strategy:
    ...
    def run_backtest(self):
        ...
        for i in range(1, len(self.df)):
            ...
            stop_loss = float(self.df['SMA_7'].iloc[i] * 0.985)  # 1.5% abaixo da média móvel
            take_profit = float(self.df['SMA_7'].iloc[i] * 1.03)  # 3% acima da média móvel
            ...
            # Verificar sinal de compra
                ...
                shares = int(self.current_capital * 0.95 / current_price)  # Usa 95% do capital disponível
